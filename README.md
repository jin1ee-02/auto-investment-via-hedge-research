...
- 서버가 종목당 20%, 현금 10%, 제안당 회전율 30%, 최소 주문 $100, 비용 여유 1%를 강제합니다.
...
- `POST /pipelines`: `{ fundIds, candidateFilter? }`
...
13F는 분기 말 보유 스냅샷이라 실제 거래일, 분기 중 왕복매매, 현재 진입 시점을 알려주지 않습니다. AI 점수·신뢰도도 검증된 수익 확률이 아닙니다.
